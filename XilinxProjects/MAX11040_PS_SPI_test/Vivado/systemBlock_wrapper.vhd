...
end systemBlock_wrapper;

architecture STRUCTURE of systemBlock_wrapper is
  component systemBlock is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
systemBlock_i: component systemBlock
     port map (

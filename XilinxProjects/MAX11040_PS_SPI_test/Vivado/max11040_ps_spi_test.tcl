...
#
# max11040_ps_spi_test.tcl: Tcl script for re-creating project 'adc_spi'
#
# Generated by Vivado on Sun Jan 05 21:00:31 +1100 2020
...
#
# 1. This project restoration tcl script (max11040_ps_spi_test.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Documents/private/home_proj/Mic_array/MiniZed/Vivado/adc_spi/adc_spi.srcs/sources_1/imports/hdl/SPI_passthrough.vhd"
#    "C:/Documents/private/home_proj/Mic_array/MiniZed/Vivado/adc_spi/adc_spi.srcs/sources_1/bd/systemBlock/hdl/systemBlock_wrapper.vhd"
#    "C:/Documents/private/home_proj/Mic_array/MiniZed/Vivado/adc_spi/adc_spi.srcs/constrs_1/new/spi_const.xdc"
#
...
set script_file "max11040_ps_spi_test.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../../ip_repo/adc_spi_ctrl_1.0"] [file normalize "$origin_dir/../../../../../ip_repo/adc_spi_ctrl_1.0"]" $obj
...
set_property -name "top" -value "systemBlock_wrapper" -objects $obj
...
if { [get_files SPI_passthrough.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Documents/private/home_proj/Mic_array/MiniZed/Vivado/adc_spi/adc_spi.srcs/sources_1/imports/hdl/SPI_passthrough.vhd
}


# Proc to create BD systemBlock
proc cr_bd_systemBlock { parentCell } {
...
# spi_passthrough
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  csiro.au:user:adc_spi_ctrl:1.0\
  ...
  # Create ports
  set led_test_0 [ create_bd_port -dir O led_test_0 ]
  ...
  # Create instance: adc_spi_ctrl_0, and set properties
  set adc_spi_ctrl_0 [ create_bd_cell -type ip -vlnv csiro.au:user:adc_spi_ctrl:1.0 adc_spi_ctrl_0 ]
  ...
  # Create instance: spi_passthrough_0, and set properties
  set block_name spi_passthrough
  set block_cell_name spi_passthrough_0
  if { [catch {set spi_passthrough_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spi_passthrough_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins adc_spi_ctrl_0/S00_AXI_SPI_CTRL] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net adc_spi_ctrl_0_ps_spi_over_ride [get_bd_pins adc_spi_ctrl_0/ps_spi_over_ride] [get_bd_pins spi_passthrough_0/ps_spi_ovrd]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins adc_spi_ctrl_0/s00_axi_spi_ctrl_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net processing_system7_0_SPI0_MISO_O [get_bd_pins processing_system7_0/SPI0_MISO_O] [get_bd_pins spi_passthrough_0/spi0_miso_o]
  connect_bd_net -net processing_system7_0_SPI0_MISO_T [get_bd_pins processing_system7_0/SPI0_MISO_T] [get_bd_pins spi_passthrough_0/spi0_miso_t]
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_pins processing_system7_0/SPI0_MOSI_O] [get_bd_pins spi_passthrough_0/spi0_mosi_o]
  connect_bd_net -net processing_system7_0_SPI0_MOSI_T [get_bd_pins processing_system7_0/SPI0_MOSI_T] [get_bd_pins spi_passthrough_0/spi0_mosi_t]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_pins processing_system7_0/SPI0_SCLK_O] [get_bd_pins spi_passthrough_0/spi0_sclk_o]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_T [get_bd_pins processing_system7_0/SPI0_SCLK_T] [get_bd_pins spi_passthrough_0/spi0_sclk_t]
  connect_bd_net -net processing_system7_0_SPI0_SS1_O [get_bd_pins processing_system7_0/SPI0_SS1_O] [get_bd_pins spi_passthrough_0/spi0_ss1_o]
  connect_bd_net -net processing_system7_0_SPI0_SS2_O [get_bd_pins processing_system7_0/SPI0_SS2_O] [get_bd_pins spi_passthrough_0/spi0_ss2_o]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_pins processing_system7_0/SPI0_SS_O] [get_bd_pins spi_passthrough_0/spi0_ss_o]
  connect_bd_net -net processing_system7_0_SPI0_SS_T [get_bd_pins processing_system7_0/SPI0_SS_T] [get_bd_pins spi_passthrough_0/spi0_ss_t]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins adc_spi_ctrl_0/s00_axi_spi_ctrl_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net spi_miso_0_1 [get_bd_ports spi_miso_0] [get_bd_pins spi_passthrough_0/spi_miso]
  connect_bd_net -net spi_passthrough_0_led_test [get_bd_ports led_test_0] [get_bd_pins spi_passthrough_0/led_test]
  connect_bd_net -net spi_passthrough_0_spi0_miso_i [get_bd_pins processing_system7_0/SPI0_MISO_I] [get_bd_pins spi_passthrough_0/spi0_miso_i]
  connect_bd_net -net spi_passthrough_0_spi0_mosi_i [get_bd_pins processing_system7_0/SPI0_MOSI_I] [get_bd_pins spi_passthrough_0/spi0_mosi_i]
  connect_bd_net -net spi_passthrough_0_spi0_sclk_i [get_bd_pins processing_system7_0/SPI0_SCLK_I] [get_bd_pins spi_passthrough_0/spi0_sclk_i]
  connect_bd_net -net spi_passthrough_0_spi0_ss_i [get_bd_pins processing_system7_0/SPI0_SS_I] [get_bd_pins spi_passthrough_0/spi0_ss_i]
  connect_bd_net -net spi_passthrough_0_spi_mosi [get_bd_ports spi_mosi_0] [get_bd_pins spi_passthrough_0/spi_mosi]
  connect_bd_net -net spi_passthrough_0_spi_sclk [get_bd_ports spi_sclk_0] [get_bd_pins spi_passthrough_0/spi_sclk]
  connect_bd_net -net spi_passthrough_0_spi_ss [get_bd_ports spi_ss_0] [get_bd_pins spi_passthrough_0/spi_ss]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs adc_spi_ctrl_0/S00_AXI_SPI_CTRL/S00_AXI_SPI_CTRL_reg] SEG_adc_spi_ctrl_0_S00_AXI_SPI_CTRL_reg
...
# End of cr_bd_systemBlock()
cr_bd_systemBlock ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files systemBlock.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files systemBlock.bd ] 
set_property IS_ENABLED "1" [get_files systemBlock.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files systemBlock.bd ] 
set_property IS_LOCKED "0" [get_files systemBlock.bd ] 
set_property IS_MANAGED "0" [get_files systemBlock.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files systemBlock.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files systemBlock.bd ] 
set_property PFM_NAME "" [get_files systemBlock.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files systemBlock.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files systemBlock.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files systemBlock.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files systemBlock.bd ] 
set_property USED_IN_SIMULATION "1" [get_files systemBlock.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files systemBlock.bd ] 

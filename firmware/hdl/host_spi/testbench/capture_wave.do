...
add wave -noupdate -format Logic -radix binary /host_spi_tben/vgen/ser_clk
add wave -noupdate -format Logic -radix hexadecimal /host_spi_tben/vgen/rx_data
add wave -noupdate -divider {DUT TOP_LEVEL SIGNALS}
add wave -noupdate -format Logic -radix binary /host_spi_tben/dut/hst_dv
add wave -noupdate -format Logic -radix binary /host_spi_tben/dut/hst_ack
add wave -noupdate -format Logic -radix hexadecimal /host_spi_tben/dut/cmd
add wave -noupdate -format Logic -radix hexadecimal /host_spi_tben/dut/addr
add wave -noupdate -format Logic -radix hexadecimal /host_spi_tben/dut/hst_din
add wave -noupdate -format Logic -radix hexadecimal /host_spi_tben/dut/hst_dout
...
add wave -noupdate -format Logic -radix binary /host_spi_tben/dut/sdo_int
